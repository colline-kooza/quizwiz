...
export default function Page() {
  ...
  function handleNext() {
    if (currentQuestion === science.length - 1) {
      setShowResults(true);
    } else {
            ...
            <div className="flex justify-between px-[1rem] py-4 lg:py-2 lg:px-[3rem]">
              <h2 className="font-[900] text-[18px] flex gap-2  lg:text-[20px]">
                ...
                <span className="text-orange-500 flex dark:text-orange-800">
                  {currentQuestion + 1}/
                  <h2 className="text-green-400">{science.length}</h2>
                </span>{" "}
              </h2>
                ...
                {question.Options.map((option) => {
                  return (
                    ...
                    >
                      ...
                      <button className="text-black font-[600] text-center">
                        {option}
                      </button>
                    </motion.div>
                  );
